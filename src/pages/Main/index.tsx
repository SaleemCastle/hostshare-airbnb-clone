...
const Main = (): ReactElement => {
    ...
    useEffect(() => {
       return !payload ? setPayload(getListings()) : console.log('Data recieved ');
    }, [payload])
    ...
    return (
        <> 
            ...
            <div className='py-3 grid-cols-3 grid items-center justify-around border-b justify-self-center'>
                {/* Logo */}
                <div className='pl-20'>
                ...
                {/* Search component */}
                <div className='flex p-4 rounded-full w-96 shadow-sm border-2 place-self-center flex-row justify-between h-12 items-center self-center cursor-pointer hover:shadow-md hover:transition-all'>
